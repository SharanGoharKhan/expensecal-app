...
app.controller("ExpenseController", ["$scope", "Restangular", "$categories", "localStorageService", "$expenses", function ($scope,Restangular,$categories,localStorageService,$expenses) {
